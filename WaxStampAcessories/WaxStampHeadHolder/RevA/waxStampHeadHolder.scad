    ...
    difference()
    {
        union()
        {
            difference()
            {
                ...
                cylinder(d=waxStamp_metric_screw_dia+5,h=waxStamp_metric_shaft_length/2);
            }
        ...
        cube([waxStamp_metric_screw_dia*2, waxStamp_metric_screw_dia/4,waxStamp_metric_shaft_length*2+1], center = true);
    }
}
