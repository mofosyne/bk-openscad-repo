...
businesscard_width = 92; // 90mm but some in real life are more like 91mm (Plus 0.5 tol )
...
module cardholder(reducePlastic=false)
{
    ...
    difference()
    {
        ...
        {
            cube([businesscard_width-wall_card_grip,businesscard_height, wall_height+1], center=true);
        }
    }
}
